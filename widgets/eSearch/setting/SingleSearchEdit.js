...
//        console.info(this.config);
      ...
      _bindEvents: function () {
        this.own(on(this.attribTableCbx, 'click', lang.hitch(this, this._need2ChkOpLyr)));
        this.own(on(this.showAttachmentsCbx, 'click', lang.hitch(this, this._need2ChkOpLyr)));
        this.own(on(this.shareCbx, 'click', lang.hitch(this, this._need2ChkOpLyr)));
